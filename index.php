	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Get Exicted About Getting Healthy </h1>
	              <h2 class="subheading mb-4"> We serve Fresh Food </h2>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-sm-12 ftco-animate text-center">
	              <h1 class="mb-2">A Healthy outside Starts From The Inside</h1>
	              <h2 class="subheading mb-4">100% Fresh &amp; Organic Foods  </h2>
	              <!-- <p><a href="#" class="btn btn-primary">View Details</a></p> -->
	            </div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/amino/16.png" class="img-fluid" style="width: 225px; height: 118px;"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/amino/17.png" class="img-fluid" style="width: 225px; height: 118px;"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/amino/13.jpg" class="img-fluid"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/amino/14.jpg" class="img-fluid"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/amino/15.jpg" class="img-fluid"></a>
    			</div>
    		</div>
    	</div>
    </section> -->
