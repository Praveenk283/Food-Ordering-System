...
<section class="content">
      ...
      ?>
              ...
              <?php 
                ...
                $sql1=$conn->prepare("SELECT * FROM customer_invoice ci,product_cart_details pcd,product_details pd,stock_details sd WHERE pd.pd_id=sd.pd_id AND pcd.pd_id=pd.pd_id AND pcd.cus_id=? AND ci.ci_order_no=? AND ci.ci_date=?");
