...
?>
	          	...
	          	<div class="col-md-12">
	          		<p style="color: #009900;">Available</p>
	          	</div>
...
?>
				...
				<div class="col-md-12">
	          		<p style="color: #ff0000;">Currently Available</p>
	          	</div>
...
?>
            ...
            <button type="submit"onclick="post()"><p class="btn btn-black py-3 px-5">Add to Cart</p></button>
