  ...
  <div class="content-wrapper">
    ...
    ?>
            ...
            <form role="form" action="admin_update.php" method="post" enctype="multipart/form-data" onsubmit="return ValidateForm()">
             <input type="hidden" name="ad_id" id="ad_id" value="<?php echo $row['ad_id'];?>">
              ...
              <div class="box-body">
                ...
                <span id="ad_name_error" class="text-danger font-weight-bold"></span>
            </div>
            ...
            <div class="form-group">
                ...
                <span id="ad_contact_error" class="text-danger font-weight-bold"></span>
            </div>
            ...
            <div class="form-group">
                ...
                <span id="ad_address_error" class="text-danger font-weight-bold"></span>
            </div>

            <div class="form-group">
                <label for="inputEmail" class="control-label">Email</label>
                <input type="text" id="ad_email" name="ad_email"class="form-control" value="<?php echo $row['ad_email'];?>">
                <span id="ad_email_error" class="text-danger font-weight-bold"></span>
            </div>
...
<?php require("5_footerscripts.php"); ?>
 ...
 <script type="text/javascript">
        function ValidateForm()
        {
            ...
            var ad_address = document.getElementById('ad_address').value;
            var ad_contact = document.getElementById('ad_contact').value;
          ...
          document.getElementById('ad_name_error').innerHTML = "  Please Enter Username ";
          return false;
         
            }
            if(ad_address =="" ){

          document.getElementById('ad_address_error').innerHTML = "  Please Enter Address ";
          return false;
         
            }
             if(ad_contact =="" ){

          document.getElementById('ad_contact_error').innerHTML = "  Please Enter Phone No ";
          return false;
         
            }
               if(ad_email =="" ){

          document.getElementById('ad_email_error').innerHTML = "  Please Enter Email Id ";
          return false;
