         ...
         ?>
            ...
            <div class="form-group">
                <label for="inputEmail" class="control-label">Unit Price</label>
                 <input type="number" id="sd_unit_price" name="sd_unit_price" class="form-control"  onkeyup="sum();" value="<?php echo $row['sd_unit_price']; ?>">
            ...
            <div class="form-group">
                <label for="inputEmail" class="control-label">Stock Quantity</label>
                 <input type="number" id="sd_qty" name="sd_qty" class="form-control"  value="<?php echo $row['sd_qty']; ?>">
            ...
            <div class="form-group">
                <label for="inputEmail" class="control-label">Discount Percentage</label>
                 <input type="number" id="sd_discount" name="sd_discount" class="form-control"  onkeyup="sum();" value="<?php echo $row['sd_discount']; ?>">
            ...
            <div class="form-group">
                <label for="inputEmail" class="control-label">Discount Price</label>
                 <input type="number" id="sd_discount_price" name="sd_discount_price" class="form-control"  value="<?php echo $row['sd_discount_price']; ?>" readonly>
                <span id="sd_discount_error"></span>
            </div>

            <div class="form-group">
                <label for="inputEmail" class="control-label">Sale Price</label>
                 <input type="number" id="sd_sale_price" name="sd_sale_price" class="form-control"  value="<?php echo $row['sd_sale_price']; ?>" readonly>
