      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="product_category_insert.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
              <div class="box-body">

            <div class="form-group">
                <label for="inputName1" class="control-label">Name</label>
                <input type="text" id="pc_name" name="pc_name" class="form-control" >
            ...
            <div class="form-group">
                ...
                <span id="pc_image_error" class="text-danger font-weight-bold"></span>
            </div>
