...
$sql->bind_param("iissssissiisssdddds",$cus_id,$b_id,$order_no,$ci_shipping_address,$ci_landmark,$ci_city,$ci_pin,$ci_state,$ci_country,$ci_delivery_charges,$contact_no,$ci_date,$payment_mode,$transaction_no,$subtotal,$tax,$total_discount,$grand_total,$status);
...
$sql1=$conn->prepare("UPDATE product_cart_details SET pcd_order_no=?,pcd_status=?,pcd_date=? WHERE cus_id=? AND pcd_status=?");
$sql1->bind_param("isiss",$order_no,$prod_cart_status,$cd_id,$pcd_cart,$pcd_date);
if($sql1->execute())
{
