         ...
         ?>
            ...
            <div class="form-group">
                <label for="inputEmail" class="control-label">Unit Price</label>
                 <input type="number" id="sd_unit_price" name="sd_unit_price" class="form-control" required onkeyup="sum();" value="<?php echo $row['sd_unit_price']; ?>">
                <span id="sd_unit_price_error"></span>
            </div>

            <div class="form-group">
                <label for="inputEmail" class="control-label">Stock Quantity</label>
                 <input type="number" id="sd_qty" name="sd_qty" class="form-control" required value="<?php echo $row['sd_qty']; ?>">
                <span id="sd_qty_error"></span>
            </div>

            <div class="form-group">
                <label for="inputEmail" class="control-label">Discount Percentage</label>
                 <input type="number" id="sd_discount" name="sd_discount" class="form-control" required onkeyup="sum();" value="<?php echo $row['sd_discount']; ?>">
                <span id="sd_discount_error"></span>
            </div>

            <div class="form-group">
                <label for="inputEmail" class="control-label">Discount Price</label>
                 <input type="number" id="sd_discount_price" name="sd_discount_price" class="form-control" required value="<?php echo $row['sd_discount_price']; ?>" readonly>
                <span id="sd_discount_error"></span>
            </div>

            <div class="form-group">
                <label for="inputEmail" class="control-label">Sale Price</label>
                 <input type="number" id="sd_sale_price" name="sd_sale_price" class="form-control" required value="<?php echo $row['sd_sale_price']; ?>" readonly>
            ...
            <div class="form-group">
                ...
                <select name="sd_status" id="sd_status" class="form-control" required>
                    ...
                    <?php 
                      if($row["sd_status"]=="Currently Unavailable")
                       {
                    ?>
                       selected
                    <?php  
